...
import pytest
from scripts.run_reconstruction_phase53 import ARM_ROLES, validate_closeout_basis, validate_seed_contract, validation_exclusions
...
def test_phase53_changes_only_recovery_objective_weight():
    p = load('ht_reconstruction_phase53_20260917.json')
    ...
    previous = load('ht_reconstruction_phase52_20260917.json')
...
def test_phase53_cohort_and_evidence_are_bound():
    p = load('ht_reconstruction_phase53_20260917.json')
    c = load('ht_reconstruction_phase53_validation_cohort_20260917.json')
    ...
    for key in ('phase52_closeout_basis','phase52_retained_metric_basis','untouched_validation_cohort'):
        record = p[key]
...
def test_phase53_rejects_stale_seeds(change):
    config = {'seed':20260920,'balanced_level_replay_contract':{'seed':20260920}}
    cohort_seed = 20260920
...
def test_phase53_rejects_missing_gradient_execution_contract():
    p = load('ht_reconstruction_phase53_20260917.json')
