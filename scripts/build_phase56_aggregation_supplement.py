...
from scripts.build_reconstruction_phase56_closeout import ARMS
...
def build(source):
    payload={'version':'phase56-aggregation-supplement-v1','status':'COMPLETE','comparison_available':False,'unavailable_arms':{'late_adaptation_control':'UNAVAILABLE_NOT_TRAINED'},'source_hashes':[],'metric_rows':[]}
...
def main():
    ...
    (ROOT/'docs/_ext/phase56_aggregation_metric_registry.json').write_text(json.dumps(registry,separators=(',',':'))+'\n');print('PASS',len(registry))
