...
def build(source):
    payload={'version':'phase57-aggregation-supplement-v1','status':'COMPLETE','independent_validation':False,'strict_selection_overlap':100,'source_hashes':[],'metric_rows':[]}
...
def main():
    ...
    (ROOT/'docs/_ext/phase57_aggregation_metric_registry.json').write_text(json.dumps(registry,separators=(',',':'))+'\n');print('PASS',len(registry))
