...
def build(source):
    payload={'version':'phase55-aggregation-supplement-v1','status':'COMPLETE','source_hashes':[],'metric_rows':[]}
...
def main():
    ...
    (ROOT/'docs/_ext/phase55_aggregation_metric_registry.json').write_text(json.dumps(registry,separators=(',',':'))+'\n');print('PASS',len(registry))
