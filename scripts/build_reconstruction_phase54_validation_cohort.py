#!/usr/bin/env python3
"""Build the untouched phase-54 validation-selection and evaluation cohorts."""
...
MANIFEST_VERSION = "hypertagging-reconstruction-phase54-cohort-v1"
STUDY_ID = "phase54-recovery-replication-20260918"
...
def main() -> int:
    ...
    if len(train_uids) != 70_000:
        raise RuntimeError("phase54 training role does not contain 70,000 events")
    ...
    validation_exclusions = phase53_uids | phase52_uids | phase51_uids | phase50_uids | phase49_uids | phase48_uids | phase47_uids | phase45_uids | phase46_uids | phase44_uids | set(historical_uids) | phase41_uids | phase43_uids | phase42_uids
    ...
    phase54_selection_set = set(selection_uids)
    phase54_evaluation_set = set(evaluation_uids)
    overlap_audit = {
        "phase35_train_vs_phase54_selection": len(train_set & phase54_selection_set),
        "phase35_train_vs_phase54_evaluation": len(train_set & phase54_evaluation_set),
        "historical_validation_vs_phase54_selection": len(
            historical_set & phase54_selection_set
        ),
        "historical_validation_vs_phase54_evaluation": len(
            historical_set & phase54_evaluation_set
        ),
        "phase35_selection_vs_phase54_selection": len(
            phase35_selection_set & phase54_selection_set
        ),
        "phase35_selection_vs_phase54_evaluation": len(
            phase35_selection_set & phase54_evaluation_set
        ),
        "phase35_evaluation_vs_phase54_selection": len(
            phase35_evaluation_set & phase54_selection_set
        ),
        "phase35_evaluation_vs_phase54_evaluation": len(
            phase35_evaluation_set & phase54_evaluation_set
        ),
        "phase36_selection_vs_phase54_selection": len(
            phase36_selection_set & phase54_selection_set
        ),
        "phase36_selection_vs_phase54_evaluation": len(
            phase36_selection_set & phase54_evaluation_set
        ),
        "phase36_evaluation_vs_phase54_selection": len(
            phase36_evaluation_set & phase54_selection_set
        ),
        "phase36_evaluation_vs_phase54_evaluation": len(
            phase36_evaluation_set & phase54_evaluation_set
        ),
        "phase37_selection_vs_phase54_selection": len(
            phase37_selection_set & phase54_selection_set
        ),
        "phase37_selection_vs_phase54_evaluation": len(
            phase37_selection_set & phase54_evaluation_set
        ),
        "phase37_evaluation_vs_phase54_selection": len(
            phase37_evaluation_set & phase54_selection_set
        ),
        "phase37_evaluation_vs_phase54_evaluation": len(
            phase37_evaluation_set & phase54_evaluation_set
        ),
        "phase38_selection_vs_phase54_selection": len(
            phase38_selection_set & phase54_selection_set
        ),
        "phase38_selection_vs_phase54_evaluation": len(
            phase38_selection_set & phase54_evaluation_set
        ),
        "phase38_evaluation_vs_phase54_selection": len(
            phase38_evaluation_set & phase54_selection_set
        ),
        "phase38_evaluation_vs_phase54_evaluation": len(
            phase38_evaluation_set & phase54_evaluation_set
        ),
        "phase39_selection_vs_phase54_selection": len(
            phase39_selection_set & phase54_selection_set
        ),
        "phase39_selection_vs_phase54_evaluation": len(
            phase39_selection_set & phase54_evaluation_set
        ),
        "phase39_evaluation_vs_phase54_selection": len(
            phase39_evaluation_set & phase54_selection_set
        ),
        "phase39_evaluation_vs_phase54_evaluation": len(
            phase39_evaluation_set & phase54_evaluation_set
        ),
        "phase40_selection_vs_phase54_selection": len(
            phase40_selection_set & phase54_selection_set
        ),
        "phase40_selection_vs_phase54_evaluation": len(
            phase40_selection_set & phase54_evaluation_set
        ),
        "phase40_evaluation_vs_phase54_selection": len(
            phase40_evaluation_set & phase54_selection_set
        ),
        "phase40_evaluation_vs_phase54_evaluation": len(
            phase40_evaluation_set & phase54_evaluation_set
        ),
        "phase54_selection_vs_phase54_evaluation": len(
            phase54_selection_set & phase54_evaluation_set
        ),
    }
    overlap_audit["phase42_vs_phase54"] = len(phase42_uids & (phase54_selection_set | phase54_evaluation_set))
    overlap_audit["phase43_vs_phase54"] = len(phase43_uids & (phase54_selection_set | phase54_evaluation_set))
    overlap_audit["phase41_vs_phase54"] = len(phase41_uids & (phase54_selection_set | phase54_evaluation_set))
    overlap_audit["independent_audit_vs_phase54"] = len(audit_uids & (phase54_selection_set | phase54_evaluation_set))
    overlap_audit["phase46_vs_phase54"] = len(phase46_uids & (phase54_selection_set | phase54_evaluation_set))
    overlap_audit["phase44_vs_phase54"] = len(phase44_uids & (phase54_selection_set | phase54_evaluation_set))
    overlap_audit["phase47_vs_phase54"] = len(phase47_uids & (phase54_selection_set | phase54_evaluation_set))
    overlap_audit["phase48_vs_phase54"] = len(phase48_uids & (phase54_selection_set | phase54_evaluation_set))
    overlap_audit["phase51_vs_phase54"] = len(phase51_uids & (phase54_selection_set | phase54_evaluation_set))
    overlap_audit["phase50_vs_phase54"] = len(phase50_uids & (phase54_selection_set | phase54_evaluation_set))
    overlap_audit["phase49_vs_phase54"] = len(phase49_uids & (phase54_selection_set | phase54_evaluation_set))
    overlap_audit["phase52_vs_phase54"] = len(phase52_uids & (phase54_selection_set | phase54_evaluation_set))
    overlap_audit["phase53_vs_phase54"] = len(phase53_uids & (phase54_selection_set | phase54_evaluation_set))
    if any(overlap_audit.values()):
        raise RuntimeError(f"phase54 cohort is not untouched: {overlap_audit}")
