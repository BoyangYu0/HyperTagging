#!/usr/bin/env python3
"""Paired event-cluster uncertainty and exact-component depth audit for Phase51."""
import argparse
...
from scripts.build_reconstruction_phase51_closeout import ARMS
...
def main():
    ...
    reports=[json.loads((args.source_root/f'artifacts/runs/ht-reconstruction-phase51-20260916/{arm}/{job}/full-decay-reports/primary_complete_target_direct.json').read_text()) for arm,job in ARMS.items()]
