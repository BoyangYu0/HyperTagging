...
MANIFEST_VERSION = "hypertagging-reconstruction-phase38-cohort-v1"
...
def main() -> int:
    ...
    phase38_selection_set = set(selection_uids)
    phase38_evaluation_set = set(evaluation_uids)
    overlap_audit = {
        "phase35_train_vs_phase38_selection": len(train_set & phase38_selection_set),
        "phase35_train_vs_phase38_evaluation": len(train_set & phase38_evaluation_set),
        "historical_validation_vs_phase38_selection": len(
            historical_set & phase38_selection_set
        ),
        "historical_validation_vs_phase38_evaluation": len(
            historical_set & phase38_evaluation_set
        ),
        "phase35_selection_vs_phase38_selection": len(
            phase35_selection_set & phase38_selection_set
        ),
        "phase35_selection_vs_phase38_evaluation": len(
            phase35_selection_set & phase38_evaluation_set
        ),
        "phase35_evaluation_vs_phase38_selection": len(
            phase35_evaluation_set & phase38_selection_set
        ),
        "phase35_evaluation_vs_phase38_evaluation": len(
            phase35_evaluation_set & phase38_evaluation_set
        ),
        "phase36_selection_vs_phase38_selection": len(
            phase36_selection_set & phase38_selection_set
        ),
        "phase36_selection_vs_phase38_evaluation": len(
            phase36_selection_set & phase38_evaluation_set
        ),
        "phase36_evaluation_vs_phase38_selection": len(
            phase36_evaluation_set & phase38_selection_set
        ),
        "phase36_evaluation_vs_phase38_evaluation": len(
            phase36_evaluation_set & phase38_evaluation_set
        ),
        "phase37_selection_vs_phase38_selection": len(
            phase37_selection_set & phase38_selection_set
        ),
        "phase37_selection_vs_phase38_evaluation": len(
            phase37_selection_set & phase38_evaluation_set
        ),
        "phase37_evaluation_vs_phase38_selection": len(
            phase37_evaluation_set & phase38_selection_set
        ),
        "phase37_evaluation_vs_phase38_evaluation": len(
            phase37_evaluation_set & phase38_evaluation_set
        ),
        "phase38_selection_vs_phase38_evaluation": len(
            phase38_selection_set & phase38_evaluation_set
        ),
    }
    if any(overlap_audit.values()):
        raise RuntimeError(f"phase38 cohort is not untouched: {overlap_audit}")
