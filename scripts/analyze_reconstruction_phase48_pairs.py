#!/usr/bin/env python3
"""Paired event-cluster uncertainty and exact-component depth audit for Phase48."""
import argparse
...
from scripts.build_reconstruction_phase48_closeout import ARMS
...
def main():
    ...
    reports=[json.loads((args.source_root/f'artifacts/runs/ht-reconstruction-phase48-20260914/{arm}/{job}/full-decay-reports/primary_complete_target_direct.json').read_text()) for arm,job in ARMS.items()]
