#!/usr/bin/env python3
"""Paired event-cluster uncertainty and exact-component depth audit for Phase50."""
import argparse
...
from scripts.build_reconstruction_phase50_closeout import ARMS
...
def main():
    ...
    reports=[json.loads((args.source_root/f'artifacts/runs/ht-reconstruction-phase50-20260915/{arm}/{job}/full-decay-reports/primary_complete_target_direct.json').read_text()) for arm,job in ARMS.items()]
