#!/usr/bin/env python3
"""Paired event-cluster uncertainty and exact-component depth audit for Phase54."""
import argparse
...
from scripts.build_reconstruction_phase54_closeout import ARMS
...
def main():
    ...
    reports=[json.loads((args.source_root/f'artifacts/runs/ht-reconstruction-phase54-20260918/{arm}/{job}/full-decay-reports/primary_complete_target_direct.json').read_text()) for arm,job in ARMS.items()]
