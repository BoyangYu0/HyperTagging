#!/usr/bin/env python3
"""Write a canonical terminal receipt for one phase-60 Slurm attempt."""
...
def main() -> int:
    ...
    payload = {
        "receipt_version": "hypertagging-reconstruction-phase60-attempt-v1",
        ...
        "artifacts": {
            ...
            "pretraining_refinement": artifact(
                args.run_root / "pretraining/refinement-result.json"
            ),
