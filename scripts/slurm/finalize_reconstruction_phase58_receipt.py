#!/usr/bin/env python3
"""Write a canonical terminal receipt for one phase-58 Slurm attempt."""
...
def main() -> int:
    ...
    payload = {
        "receipt_version": "hypertagging-reconstruction-phase58-attempt-v1",
        ...
        "artifacts": {
            ...
            "pretraining_refinement": artifact(args.run_root / "pretraining/refinement-result.json"),
