#!/usr/bin/env python3
"""Build the untouched phase-41 validation-selection and evaluation cohorts."""
...
MANIFEST_VERSION = "hypertagging-reconstruction-phase41-cohort-v1"
...
def main() -> int:
    ...
    if len(train_uids) != 70_000:
        raise RuntimeError("phase41 training role does not contain 70,000 events")
    ...
    phase41_selection_set = set(selection_uids)
    phase41_evaluation_set = set(evaluation_uids)
    overlap_audit = {
        "phase35_train_vs_phase41_selection": len(train_set & phase41_selection_set),
        "phase35_train_vs_phase41_evaluation": len(train_set & phase41_evaluation_set),
        "historical_validation_vs_phase41_selection": len(
            historical_set & phase41_selection_set
        ),
        "historical_validation_vs_phase41_evaluation": len(
            historical_set & phase41_evaluation_set
        ),
        "phase35_selection_vs_phase41_selection": len(
            phase35_selection_set & phase41_selection_set
        ),
        "phase35_selection_vs_phase41_evaluation": len(
            phase35_selection_set & phase41_evaluation_set
        ),
        "phase35_evaluation_vs_phase41_selection": len(
            phase35_evaluation_set & phase41_selection_set
        ),
        "phase35_evaluation_vs_phase41_evaluation": len(
            phase35_evaluation_set & phase41_evaluation_set
        ),
        "phase36_selection_vs_phase41_selection": len(
            phase36_selection_set & phase41_selection_set
        ),
        "phase36_selection_vs_phase41_evaluation": len(
            phase36_selection_set & phase41_evaluation_set
        ),
        "phase36_evaluation_vs_phase41_selection": len(
            phase36_evaluation_set & phase41_selection_set
        ),
        "phase36_evaluation_vs_phase41_evaluation": len(
            phase36_evaluation_set & phase41_evaluation_set
        ),
        "phase37_selection_vs_phase41_selection": len(
            phase37_selection_set & phase41_selection_set
        ),
        "phase37_selection_vs_phase41_evaluation": len(
            phase37_selection_set & phase41_evaluation_set
        ),
        "phase37_evaluation_vs_phase41_selection": len(
            phase37_evaluation_set & phase41_selection_set
        ),
        "phase37_evaluation_vs_phase41_evaluation": len(
            phase37_evaluation_set & phase41_evaluation_set
        ),
        "phase38_selection_vs_phase41_selection": len(
            phase38_selection_set & phase41_selection_set
        ),
        "phase38_selection_vs_phase41_evaluation": len(
            phase38_selection_set & phase41_evaluation_set
        ),
        "phase38_evaluation_vs_phase41_selection": len(
            phase38_evaluation_set & phase41_selection_set
        ),
        "phase38_evaluation_vs_phase41_evaluation": len(
            phase38_evaluation_set & phase41_evaluation_set
        ),
        "phase39_selection_vs_phase41_selection": len(
            phase39_selection_set & phase41_selection_set
        ),
        "phase39_selection_vs_phase41_evaluation": len(
            phase39_selection_set & phase41_evaluation_set
        ),
        "phase39_evaluation_vs_phase41_selection": len(
            phase39_evaluation_set & phase41_selection_set
        ),
        "phase39_evaluation_vs_phase41_evaluation": len(
            phase39_evaluation_set & phase41_evaluation_set
        ),
        "phase40_selection_vs_phase41_selection": len(
            phase40_selection_set & phase41_selection_set
        ),
        "phase40_selection_vs_phase41_evaluation": len(
            phase40_selection_set & phase41_evaluation_set
        ),
        "phase40_evaluation_vs_phase41_selection": len(
            phase40_evaluation_set & phase41_selection_set
        ),
        "phase40_evaluation_vs_phase41_evaluation": len(
            phase40_evaluation_set & phase41_evaluation_set
        ),
        "phase41_selection_vs_phase41_evaluation": len(
            phase41_selection_set & phase41_evaluation_set
        ),
    }
    if any(overlap_audit.values()):
        raise RuntimeError(f"phase41 cohort is not untouched: {overlap_audit}")
