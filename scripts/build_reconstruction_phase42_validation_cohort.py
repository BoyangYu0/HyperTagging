#!/usr/bin/env python3
"""Build the untouched phase-42 validation-selection and evaluation cohorts."""
...
MANIFEST_VERSION = "hypertagging-reconstruction-phase42-cohort-v1"
STUDY_ID = "phase42-pretraining-transfer-20260909"
...
def main() -> int:
    ...
    if len(train_uids) != 70_000:
        raise RuntimeError("phase42 training role does not contain 70,000 events")
    ...
    validation_exclusions = set(historical_uids) | phase41_uids
    ...
    phase42_selection_set = set(selection_uids)
    phase42_evaluation_set = set(evaluation_uids)
    overlap_audit = {
        "phase35_train_vs_phase42_selection": len(train_set & phase42_selection_set),
        "phase35_train_vs_phase42_evaluation": len(train_set & phase42_evaluation_set),
        "historical_validation_vs_phase42_selection": len(
            historical_set & phase42_selection_set
        ),
        "historical_validation_vs_phase42_evaluation": len(
            historical_set & phase42_evaluation_set
        ),
        "phase35_selection_vs_phase42_selection": len(
            phase35_selection_set & phase42_selection_set
        ),
        "phase35_selection_vs_phase42_evaluation": len(
            phase35_selection_set & phase42_evaluation_set
        ),
        "phase35_evaluation_vs_phase42_selection": len(
            phase35_evaluation_set & phase42_selection_set
        ),
        "phase35_evaluation_vs_phase42_evaluation": len(
            phase35_evaluation_set & phase42_evaluation_set
        ),
        "phase36_selection_vs_phase42_selection": len(
            phase36_selection_set & phase42_selection_set
        ),
        "phase36_selection_vs_phase42_evaluation": len(
            phase36_selection_set & phase42_evaluation_set
        ),
        "phase36_evaluation_vs_phase42_selection": len(
            phase36_evaluation_set & phase42_selection_set
        ),
        "phase36_evaluation_vs_phase42_evaluation": len(
            phase36_evaluation_set & phase42_evaluation_set
        ),
        "phase37_selection_vs_phase42_selection": len(
            phase37_selection_set & phase42_selection_set
        ),
        "phase37_selection_vs_phase42_evaluation": len(
            phase37_selection_set & phase42_evaluation_set
        ),
        "phase37_evaluation_vs_phase42_selection": len(
            phase37_evaluation_set & phase42_selection_set
        ),
        "phase37_evaluation_vs_phase42_evaluation": len(
            phase37_evaluation_set & phase42_evaluation_set
        ),
        "phase38_selection_vs_phase42_selection": len(
            phase38_selection_set & phase42_selection_set
        ),
        "phase38_selection_vs_phase42_evaluation": len(
            phase38_selection_set & phase42_evaluation_set
        ),
        "phase38_evaluation_vs_phase42_selection": len(
            phase38_evaluation_set & phase42_selection_set
        ),
        "phase38_evaluation_vs_phase42_evaluation": len(
            phase38_evaluation_set & phase42_evaluation_set
        ),
        "phase39_selection_vs_phase42_selection": len(
            phase39_selection_set & phase42_selection_set
        ),
        "phase39_selection_vs_phase42_evaluation": len(
            phase39_selection_set & phase42_evaluation_set
        ),
        "phase39_evaluation_vs_phase42_selection": len(
            phase39_evaluation_set & phase42_selection_set
        ),
        "phase39_evaluation_vs_phase42_evaluation": len(
            phase39_evaluation_set & phase42_evaluation_set
        ),
        "phase40_selection_vs_phase42_selection": len(
            phase40_selection_set & phase42_selection_set
        ),
        "phase40_selection_vs_phase42_evaluation": len(
            phase40_selection_set & phase42_evaluation_set
        ),
        "phase40_evaluation_vs_phase42_selection": len(
            phase40_evaluation_set & phase42_selection_set
        ),
        "phase40_evaluation_vs_phase42_evaluation": len(
            phase40_evaluation_set & phase42_evaluation_set
        ),
        "phase42_selection_vs_phase42_evaluation": len(
            phase42_selection_set & phase42_evaluation_set
        ),
    }
    overlap_audit["phase41_vs_phase42"] = len(phase41_uids & (phase42_selection_set | phase42_evaluation_set))
    if any(overlap_audit.values()):
        raise RuntimeError(f"phase42 cohort is not untouched: {overlap_audit}")
