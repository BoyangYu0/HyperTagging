...
MANIFEST_VERSION = "hypertagging-reconstruction-phase37-cohort-v1"
...
def main() -> int:
    ...
    phase37_selection_set = set(selection_uids)
    phase37_evaluation_set = set(evaluation_uids)
    overlap_audit = {
        "phase35_train_vs_phase37_selection": len(train_set & phase37_selection_set),
        "phase35_train_vs_phase37_evaluation": len(train_set & phase37_evaluation_set),
        "historical_validation_vs_phase37_selection": len(
            historical_set & phase37_selection_set
        ),
        "historical_validation_vs_phase37_evaluation": len(
            historical_set & phase37_evaluation_set
        ),
        "phase35_selection_vs_phase37_selection": len(
            phase35_selection_set & phase37_selection_set
        ),
        "phase35_selection_vs_phase37_evaluation": len(
            phase35_selection_set & phase37_evaluation_set
        ),
        "phase35_evaluation_vs_phase37_selection": len(
            phase35_evaluation_set & phase37_selection_set
        ),
        "phase35_evaluation_vs_phase37_evaluation": len(
            phase35_evaluation_set & phase37_evaluation_set
        ),
        "phase36_selection_vs_phase37_selection": len(
            phase36_selection_set & phase37_selection_set
        ),
        "phase36_selection_vs_phase37_evaluation": len(
            phase36_selection_set & phase37_evaluation_set
        ),
        "phase36_evaluation_vs_phase37_selection": len(
            phase36_evaluation_set & phase37_selection_set
        ),
        "phase36_evaluation_vs_phase37_evaluation": len(
            phase36_evaluation_set & phase37_evaluation_set
        ),
        "phase37_selection_vs_phase37_evaluation": len(
            phase37_selection_set & phase37_evaluation_set
        ),
    }
    if any(overlap_audit.values()):
        raise RuntimeError(f"phase37 cohort is not untouched: {overlap_audit}")
